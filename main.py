...
# This part is image labels setting start 
        # first header image  
        img=Image.open(r"Python_Test_Projects\Images_GUI\banner.jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"Python_Test_Projects\Images_GUI\bg3.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"Python_Test_Projects\Images_GUI\std1.jpg")
        ...
        det_img_btn=Image.open(r"Python_Test_Projects\Images_GUI\det1.jpg")
        ...
        att_img_btn=Image.open(r"Python_Test_Projects\Images_GUI\att.jpg")
        ...
        hlp_img_btn=Image.open(r"Python_Test_Projects\Images_GUI\hlp.jpg")
        ...
        # Start below buttons.........
         # Train   button 5
        tra_img_btn=Image.open(r"Python_Test_Projects\Images_GUI\tra1.jpg")
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"Python_Test_Projects\Images_GUI\qr1.png")
        ...
        # Developers   button 7
        dev_img_btn=Image.open(r"Python_Test_Projects\Images_GUI\dev.jpg")
        ...
        # exit   button 8
        exi_img_btn=Image.open(r"Python_Test_Projects\Images_GUI\exi.jpg")
